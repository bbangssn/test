...
public class GetFromApi {
    ...
    private static String TAG = "GetFromApi";


    public static JSONArray getData(String keyword) {

        String URL = "http://apis.data.go.kr/B551011/KorService/searchKeyword";
        String key = "hdm+J7CIiigXHZKn6gTL8LAEIcBLdy8UHWpq/IeWN8b9tLVasMcCiUmfyaoRRwhPqEH2pQQpUxqC2swg8jx46A==";
        ...
        try {
            ...
            return (new JSONObject(sb.toString())).getJSONObject("response").getJSONObject("body").getJSONObject("items").getJSONArray("item");
        } catch (Exception e) {
            Log.e(TAG, "error : ", e);
